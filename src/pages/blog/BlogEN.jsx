  ...
  return (
    <div>
      ...
      <div className="position-relative" style={{ maxHeight: '300px', overflow: 'hidden' }}>
        <img src="/images/hero1.jpg" alt="News" className="w-100" style={{ objectFit: 'cover', maxHeight: '300px' }} />
            ...
            <div className="col-md-6 col-lg-4" key={post.id}>
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <Link to={`/en/blog/${post.slug}`} className="btn btn-outline-primary">Read More</Link>
                </div>
              </div>
            </div>
          ))}
